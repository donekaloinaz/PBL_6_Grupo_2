function [bwselected,cropped_image_wvessels,cropcentre,Crop_Vessels_Removed,disclogical,cuplogical,cupcorrected,cupdiscmask,cupdiscmaskcorrected,ISNTadequate,seggreen] = origfullsegmentation(I)
